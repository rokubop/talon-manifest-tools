...
| requires | Auto-detected hardware/software requirements. Possible values: `"talonBeta"`, `"eyeTracker"`, `"parrot"`, `"gamepad"`, `"streamDeck"`, `"webcam"`. Example: `["talonBeta", "eyeTracker"]`. Set `_generatorUpdateRequires` to false to preserve manual edits. |
