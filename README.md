...
| dependencyCheck | Whether to validate dependencies at runtime (default: true if dependencies exist, omitted otherwise). Set to false to disable dependency validation. |
| contributes | Auto-generated. Actions/settings/etc. this package provides |
| depends | Auto-generated. Actions/settings/etc. this package uses |
